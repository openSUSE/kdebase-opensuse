/*
   10-opensuse-plasmanm.js - Add NM plasmoid to the systray
   lifted and adapted from fedora by Hrvoje Senjan <hrvoje.senjan@gmail.com>
...
for (i = 0; i < pids.length; ++i) {
  ...
  for (j = 0; j < ids.length; ++j) {
    ...
    w.writeConfig("plugin", "org.kde.plasma-nm");
